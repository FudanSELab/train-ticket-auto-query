...
if __name__ == '__main__':
    ...
    Authorization = "eyJhbGciOiJIUzI1NiJ9.eyJzdWIiOiJmZHNlX21pY3Jvc2VydmljZSIsInJvbGVzIjpbIlJPTEVfVVNFUiJdLCJpZCI6IjRkMmE0NmM3LTcxY2ItNGNmMS1iNWJiLWI2ODQwNmQ5ZGE2ZiIsImlhdCI6MTYyNzU1NTQxOCwiZXhwIjoxNjI3NTU5MDE4fQ.HAbO0QmGMCcR3kpr0FM9Sro25mGWRm__K-BR7N-rERE"
    headers = {
        'Connection': 'close',
        "Cookie": f"{cookie}",
