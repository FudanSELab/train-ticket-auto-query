...
if __name__ == '__main__':
    ...
    Authorization = "eyJhbGciOiJIUzI1NiJ9.eyJzdWIiOiJmZHNlX21pY3Jvc2VydmljZSIsInJvbGVzIjpbIlJPTEVfVVNFUiJdLCJpZCI6IjRkMmE0NmM3LTcxY2ItNGNmMS1iNWJiLWI2ODQwNmQ5ZGE2ZiIsImlhdCI6MTYyNzU0Mzg4MSwiZXhwIjoxNjI3NTQ3NDgxfQ.DGsBEZNZQFFqaF3Iq-OPt7ZeOEtck6EzpY2EZ2kcRvA"
    headers = {
        'Connection': 'close',
        "Cookie": f"{cookie}",
